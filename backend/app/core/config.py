...
class Settings:
    def __init__(self) -> None:
        ...
        # Email Settings
        self.mail_username: str = os.getenv("MAIL_USERNAME", "clinicasangabrieldao@gmail.com")
        self.mail_password: str = os.getenv("MAIL_PASSWORD", "xokatlrbnhqdzpzz")
        self.mail_from: str = os.getenv("MAIL_FROM", "clinicasangabrieldao@gmail.com")
